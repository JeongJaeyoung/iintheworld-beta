...
export default function TermsOfService() {
    return (
        <>
            <div id='terms-of-service-wrapper'>
                <div>
                    표준약관 제10023호
                </div>
                <div>
                    제1조(목적) <br />
                    이 약관은 내가 사는 세상(전자상거래 사업자)가 운영하는 내가 배우는 세상 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.<br />
                    ※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」
                </div>

                <div>
                    제2조(정의)<br />
                    ① “몰”이란 내가 사는 세상 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.<br />
